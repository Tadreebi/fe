    ...
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              By adding <a href="https://tadreebi.net/docs/layout/gutters/">gutter modifier classes</a>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              layouts. By adding{' '}
              <a href="https://tadreebi.net/docs/layout/gutters/">gutter modifier classes</a>, we will
