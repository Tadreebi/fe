...
// import { DocsCallout, div } from 'src/components'
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              <a href="https://tadreebi.net/docs/utilities/spacing">spacing utilities</a> as needed.
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-medium-emphasis small">
              Use some of{' '}
              <a href="https://tadreebi.net/docs/utilities/sizing/">available sizing utilities</a> to
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              parts—with{' '}
              <a href="https://tadreebi.net/docs/utilities/text/#text-alignment">text align classes</a>
              .
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <h3>Border</h3>
            <p className="text-medium-emphasis small">
              Use <a href="https://tadreebi.net/docs/utilities/borders/">border utilities</a> to change
