...
// import { DocsCallout, a } from 'src/components'
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              <a href="https://tadreebi.net/docs/4.0/utilities/api">utilities</a>, or by adding your
              ...
              <a href="https://icons.tadreebi.net">CoreUI Icons</a>, and using some{' '}
              <a href="https://tadreebi.net/docs/4.0/utilities/flex">flexbox utilities</a> to adjust
              the layout.
            </p>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              <a href="https://tadreebi.net/docs/4.0/utilities/colors">color</a> and{' '}
              <a href="https://tadreebi.net/docs/4.0//utilities/background">background</a> utilities.
